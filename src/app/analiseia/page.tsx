        ...
        <main>
            ...
            <form>
                ...
                <section>
                    ...
                    <input type="radio" name="sabe sobre salesforce" id="q4-1" value={1}/><label htmlFor="q4-1">1</label>
                    <input type="radio" name="sabe sobre salesforce" id="q4-2" value={2}/><label htmlFor="q4-2">2</label>
                    <input type="radio" name="sabe sobre salesforce" id="q4-3" value={3}/><label htmlFor="q4-3">3</label>
                    <input type="radio" name="sabe sobre salesforce" id="q4-4" value={4}/><label htmlFor="q4-4">4</label>
                    <input type="radio" name="sabe sobre salesforce" id="q4-5" value={5}/><label htmlFor="q4-5">5</label>
                </section>

                <input type="button" value="Realizar análise" />
            </form>
        </main>
    )
}