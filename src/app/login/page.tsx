    ...
    return (
        <main className="pagina-login">
            <section className="secao-login">
                ...
                arialabel="Entrar na plataforma de aprendizado"
                />
                <BtnLogin
                    ...
                    arialabel="Entrar na plataforma de marquetin"
                />
            </section>
        </main>
    )
